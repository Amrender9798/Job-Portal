export let Jobs = [
  { id: 1, company: "ABC Corporation", role: "Software Engineer", location: "City A", package: "$80,000 - $100,000", skills: ["JavaScript", "React", "Node.js", "MongoDB"] },
  { id: 2, company: "XYZ Tech", role: "Data Scientist", location: "City B", package: "$90,000 - $120,000", skills: ["Python", "Machine Learning"] },
  { id: 3, company: "Tech Innovators", role: "UX/UI Designer", location: "City C", package: "$70,000 - $90,000", skills: ["UI/UX Design", "Sketch", "Adobe XD"] },
  { id: 4, company: "Tech Innovations Ltd.", role: "Full Stack Developer", location: "City D", package: "$85,000 - $110,000", skills: ["JavaScript", "React", "Node.js", "Express"] },
  { id: 5, company: "Data Insights Inc.", role: "Data Engineer", location: "City E", package: "$95,000 - $120,000", skills: ["Python", "SQL", "Big Data", "ETL"] },
  { id: 6, company: "E-commerce Solutions", role: "Digital Marketing Specialist", location: "City F", package: "$75,000 - $95,000", skills: ["SEO", "SEM", "Social Media Marketing"] },
  ...
  { id: 8, company: "HealthTech Solutions", role: "Healthcare Data Analyst", location: "City H", package: "$90,000 - $115,000", skills: ["Data Analysis", "Health Informatics"] },
  ...
  { id: 10, company: "Innovative Labs", role: "Machine Learning Engineer", location: "City J", package: "$100,000 - $120,000", skills: ["Machine Learning", "TensorFlow"] },
